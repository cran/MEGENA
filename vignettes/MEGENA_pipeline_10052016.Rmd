...
## MEGENA pipeline as of 10/05/2016 

This is a routine MEGENA pipeline description encompassing from data correlation analysis to module plotting, and is based on version 1.3.4-6 <https://CRAN.R-project.org/package=MEGENA>.Please cite the paper below when MEGENA is applied as part of your analysis: 
